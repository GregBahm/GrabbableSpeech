...
namespace Microsoft.MixedReality.Toolkit.UI
{
    ...
    public class PressableButton : MonoBehaviour, IMixedRealityTouchHandler
    {
        ...
        private GameObject outerButtonVisuals = null;
        [SerializeField]
        private GameObject innerButtonVisuals = null;
        ...
        {
            Transform sourcePositionTransform = (outerButtonVisuals != null) ? outerButtonVisuals.transform : transform;
        ...
        {
            if (outerButtonVisuals != null)
            {
                Debug.Assert(initialTransform != null);
                outerButtonVisuals.transform.position = initialTransform.position + WorldSpacePressDirection * currentPushDistance;
            }

            if (innerButtonVisuals != null)
            {
                Debug.Assert(initialTransform != null);
                float innerPushDistance = currentPushDistance * 1.9f;
                innerButtonVisuals.transform.position = initialTransform.position + WorldSpacePressDirection * innerPushDistance;
            }
        }
