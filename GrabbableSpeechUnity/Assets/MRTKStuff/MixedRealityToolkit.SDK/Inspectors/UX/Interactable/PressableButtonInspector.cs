...
namespace Microsoft.MixedReality.Toolkit.Editor
{
    ...
    public class PressableButtonInspector : UnityEditor.Editor
    {
        ...
        private SerializedProperty outerButtonVisuals;
        ...
        private void OnEnable()
        {
            ...
            outerButtonVisuals = serializedObject.FindProperty("outerButtonVisuals");
            ...
            if (outerButtonVisuals.objectReferenceValue != null)
            {
                buttonContentTransform = (outerButtonVisuals.objectReferenceValue as GameObject).transform;
            }
        }
